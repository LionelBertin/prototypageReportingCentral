- Collaborateurs
-- Matricules et Login collaborateur
--- userId
--- login
--- matricule de paie
-- Etat civil collaborateur
--- photo
--- titre
--- nom (*)
--- prénom (*)
...
--- date de naissance
--- âge
-- Adresse de résidence collaborateur
--- rue (*)
--- complément
--- code postal (*)
--- ville (*)
--- pays
-- Informations contact collaborateur
--- email personnel
--- téléphone personnel (*)
-- Contact d'urgence collaborateur
--- nom (*)
--- relation
--- téléphone (*)
-- Documents d'identité collaborateur 1..n <> 1 Collaborateur
--- type de document
--- document (*)
--- date émission
--- date expiration (*)
-- Enfants à charge collaborateur 0..n <> 1 Collaborateur
--- nom
--- prénom (*)
--- genre
--- date de naissance (*)
-- Taille goodies collaborateur
--- taille en cm
--- taille tshirt (*)
- Contrats
...
-- Entretiens
  ...
  0..n <> 1 Collaborateur manager
--- type d'entretien ["Entretien préalable","Entretien annuel","Entretien retour maternité"]
...
--- date réception
--- date règlement
--- statut (*) ["à vérifier","rejetée","à régler","réglée"]
--- devise (*)
--- montant HT
--- montant TTC (*)
- Recrutement
...
-- Candidats <> 1..n Candidatures
--- nom
--- prénom
-- Candidature
  0..n <> 1..n Postes à pourvoir
